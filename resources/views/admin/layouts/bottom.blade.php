...
<!--Menu sidebar -->
<script src="{{ asset('public/style_files/backend/dist/js/sidebarmenu.js') }}"></script>
<!--Custom JavaScript -->
<script src="{{ asset('public/style_files/backend/dist/js/feather.min.js') }}"></script>
<script src="{{ asset('public/style_files/backend/dist/js/custom.min.js') }}"></script>
<script src="{{ asset('public/style_files/backend/dist/js/custom_lal.js') }}"></script>
<!-- ############################################################### -->
...
{{-- Miltiple Select --}}
<script src="{{ asset('public/style_files/backend/src/assets/libs/select2/dist/js/select2.full.min.js') }}"></script>
<script src="{{ asset('public/style_files/backend/src/assets/libs/select2/dist/js/select2.min.js') }}"></script>
<script src="{{ asset('public/style_files/backend/dist/js/pages/forms/select2/select2.init.js') }}"></script>

<script src="https://kit.fontawesome.com/ed7345c725.js" crossorigin="anonymous"></script>
