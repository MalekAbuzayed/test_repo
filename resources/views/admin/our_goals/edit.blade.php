    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('super_admin.our_goals-update', $ourGoal->id) }}" method="POST" id="ourGoalForm">
                            @csrf
                            <div class="form">
                                <div class="row">
                                    {{-- icon --}}
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <small class="text-info mt-2 d-block">
                                            <i class="bi bi-{{ old('icon', $ourGoal->icon) }}"></i>
                                            Preview: bi-{{ old('icon', $ourGoal->icon) }}
                                        </small>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="title_ar" required
                                                   ...
                                                   value="{{ old('title_ar', $ourGoal->title_ar) }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="title_en" required
                                                   ...
                                                   value="{{ old('title_en', $ourGoal->title_en) }}"
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <div class="input-group">
                                            <textarea class="form-control ar ckeditor-textarea" required
                                                      ...
                                                      rows="4">{{ old('description_ar', $ourGoal->description_ar) }}</textarea>
                                        </div>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <div class="input-group">
                                            <textarea class="form-control ckeditor-textarea" required
                                                      ...
                                                      rows="4">{{ old('description_en', $ourGoal->description_en) }}</textarea>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <button class="btn btn-primary" type="submit">
                                            <i data-feather="save" class="fill-white feather-sm"></i> Update Goal
                                        </button>
                                        <a href="{{ route('super_admin.our_goals-index') }}" class="btn btn-secondary">
                                            <i data-feather="x" class="fill-white feather-sm"></i> Cancel
                                        </a>
                                        <a href="{{ route('super_admin.our_goals-show', $ourGoal->id) }}" class="btn btn-info">
...
@section('extra_js')
    ...
    <script>
        ...
        document.querySelector('input[name="icon"]').addEventListener('input', function(e) {
            ...
            if (previewElement) {
                previewElement.className = 'bi bi-' + (iconValue || $ourGoal->icon);
            }
            if (previewText) {
                previewText.textContent = 'Preview: bi-' + (iconValue || $ourGoal->icon);
            }
        });
    </script>
@endsection
