    ...
    <div class="container-fluid">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form
                        action="{{ route('super_admin.privacy_policies-update', isset($privacyPolicy->id) ? $privacyPolicy->id : -1) }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating mb-3">
                                    <input type="text" name="title_en"
                                        ...
                                        id="tb-name"
                                        value="{{ isset($privacyPolicy->title_en) ? $privacyPolicy->title_en : null }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-floating mb-3">
                                    <input type="text" name="title_ar"
                                        ...
                                        id="tb-name"
                                        value="{{ isset($privacyPolicy->title_ar) ? $privacyPolicy->title_ar : null }}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <select name="status"
                                        ...
                                        <option value="1" @if ($privacyPolicy->status == 'Active') selected @endif
                                            @if ($privacyPolicy->status == null) selected @endif>Active </option>
                                        <option value="2" @if ($privacyPolicy->status == 'Inactive') selected @endif>
                                            Inactive </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="description_en"
                                    ...
                                    placeholder="Description En" rows="5">{{ isset($privacyPolicy->description_en) ? $privacyPolicy->description_en : null }}</textarea>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="description_ar"
                                    ...
                                    placeholder="Description AR" rows="5">{{ isset($privacyPolicy->description_ar) ? $privacyPolicy->description_ar : null }}</textarea>
