                    ...
                    <div class="card-body">
                        <form
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="numbers" name="phone" min="0"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <select name="status"
                                            ...
                                            <option value="1" @if ($user->status == 'Active') selected @endif
                                                @if ($user->status == null) selected @endif>Active
                                            </option>
                                            <option value="2" @if ($user->status == 'Inactive') selected @endif>
                                                Inactive </option>
                                        </select>
                                    </div>
                                </div>
